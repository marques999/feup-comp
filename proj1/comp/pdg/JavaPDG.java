...
public class JavaPDG {
    private static DotGraph dotGraph = new DotGraph("Example");
    ...
    public static void main(String[] args) {
        dotGraph.setEdgeColor("blue");
        dotGraph.setEdgeStyle("dotted");
        dotGraph.setDpi(15);
        ...
        dotGraph.generateDotFile("myGraph.dot");
        dotGraph.outputGraph("pdf", "dot");
    }
    ...
    public static void treeTraverse(final JsonValue jsonObject, final JsonValue jsonParent, int currentDepth) {
        if (jsonObject.isArray()) {
            ...
            dotGraph.connectDirected(parentIndex, vertexlabel);
            dotGraph.setVertexLabel(vertexlabel, jsonObject.asObject().getString("name", "Unknown"));
